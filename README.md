...
| Name | Type |
|------|------|
| [google_compute_subnetwork.cluster_subnet](https://registry.terraform.io/providers/hashicorp/google/3.76.0/docs/resources/compute_subnetwork) | resource |
...
| [google_compute_network.default](https://registry.terraform.io/providers/hashicorp/google/3.76.0/docs/data-sources/compute_network) | data source |
...
| <a name="input_cloud_dns_domain_name"></a> [cloud\_dns\_domain\_name](#input\_cloud\_dns\_domain\_name) | The suffix used for the domain of the managed DNS zone in GCP's Cloud DNS, e.g. "myzone.example.com". Required if the input "create\_cloud\_dns\_zone" is set to true | `string` | `null` | no |
| <a name="input_cloud_dns_zone_name"></a> [cloud\_dns\_zone\_name](#input\_cloud\_dns\_zone\_name) | Identifies the DNS zone for the project. Must be unique in the project, and is required if the input "create\_cloud\_dns\_zone" is set to true | `string` | `null` | no |
| <a name="input_cloud_dns_zone_type"></a> [cloud\_dns\_zone\_type](#input\_cloud\_dns\_zone\_type) | Type of zone to create, valid values are 'public', 'private', 'forwarding', 'peering'. Defaults to "public". | `string` | `"public"` | no |
...
| <a name="input_cluster_location"></a> [cluster\_location](#input\_cluster\_location) | The GCP location (region) where your cluster will be created. This module only supports regional clusters. | `string` | n/a | yes |
| <a name="input_cluster_name"></a> [cluster\_name](#input\_cluster\_name) | The name of your GKE cluster. | `string` | n/a | yes |
| <a name="input_cluster_network_policy"></a> [cluster\_network\_policy](#input\_cluster\_network\_policy) | Enable the network policy addon for the cluster. Defaults to "true". | `bool` | `true` | no |
| <a name="input_cluster_subnet_cidr"></a> [cluster\_subnet\_cidr](#input\_cluster\_subnet\_cidr) | The primary IPv4 CIDR range to use for the GKE cluster network. Used when the input "create\_cluster\_subnet" is set to "true". Defaults to "10.88.0.0/22". | `string` | `"10.88.0.0/22"` | no |
| <a name="input_cluster_subnet_pods_cidr"></a> [cluster\_subnet\_pods\_cidr](#input\_cluster\_subnet\_pods\_cidr) | The secondary IPv4 CIDR range used for the GKE cluster pod network. Used when the input "create\_cluster\_subnet" is set to "true". Defaults to "10.24.0.0/14". | `string` | `"10.24.0.0/14"` | no |
| <a name="input_cluster_subnet_services_cidr"></a> [cluster\_subnet\_services\_cidr](#input\_cluster\_subnet\_services\_cidr) | The secondary IPv4 CIDR range used for the GKE cluster service network. Used when the input "create\_cluster\_subnet" is set to "true". Defaults to "10.88.16.0/20". | `string` | `"10.88.16.0/20"` | no |
| <a name="input_create_cluster_subnet"></a> [create\_cluster\_subnet](#input\_create\_cluster\_subnet) | Creates a dedicated subnet for the cluster in the default VPC. | `bool` | `true` | no |
...
| <a name="input_release_channel"></a> [release\_channel](#input\_release\_channel) | The Kubernetes release channel to use for the cluster. Accepted values are "UNSPECIFIED", "RAPID", "REGULAR" and "STABLE". Defaults to "UNSPECIFIED". | `string` | `null` | no |
| <a name="input_remove_default_node_pool"></a> [remove\_default\_node\_pool](#input\_remove\_default\_node\_pool) | Removes the default node pool from the cluster. Defaults to "true". | `bool` | `true` | no |
| <a name="input_vpc_network"></a> [vpc\_network](#input\_vpc\_network) | The name of the VPC network to use for the cluster. Defaults to the project "default" VPC. | `string` | `"default"` | no |
| <a name="input_vpc_subnet"></a> [vpc\_subnet](#input\_vpc\_subnet) | The name of the VPC subnetwork to use for the cluster. Defaults to the project "default" subnet. | `string` | `"default"` | no |
